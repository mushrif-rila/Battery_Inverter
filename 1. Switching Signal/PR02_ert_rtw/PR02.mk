###########################################################################
## Makefile generated for component 'PR02'. 
## 
## Makefile     : PR02.mk
## Generated on : Wed Dec 04 14:05:57 2024
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/PR02.out
...
START_DIR                 = C:/Users/Mushrif/DOWNLO~1/SWITCH~2
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = TI C28x
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/PR02.out
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(START_DIR)/PR02_ert_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2022b/toolbox/target/SUPPOR~1/tic2000/inc -I$(MATLAB_ROOT)/toolbox/shared/can/src/scanutil -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2022b/toolbox/target/SUPPOR~1/tic2000/src -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2022b/toolbox/shared/SUPPOR~1/tic2000/src -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2022b/toolbox/shared/SUPPOR~1/tic2000/inc -IC:/ti/c2000/C2000W~1/LIBRAR~1/CALIBR~1/hrpwm/f2837xd/include -IC:/ti/c2000/C2000W~1/DRIVER~1/f2837xd/DRIVER~1 -IC:/ti/c2000/C2000W~1/DRIVER~1/f2837xd/DRIVER~1/inc -IC:/ti/c2000/C2000W~1/DEVICE~1/f2837xd/common/include -IC:/ti/c2000/C2000W~1/DEVICE~1/f2837xd/headers/include -IC:/ti/c2000/C2000W~1/DEVICE~1/f2837xd/common
...
DEFINES_STANDARD = -DMODEL=PR02 -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = MW_c28xx_csl.obj MW_c28xx_board.obj MW_c28xx_pwm.obj PR02.obj PR02_data.obj sysctl.obj c2837xDBoard_Realtime_Support.obj MW_c28xGlobalInterrupts.obj dma.obj F2837xD_CpuTimers.obj F2837xD_DefaultISR.obj F2837xD_GlobalVariableDefs.obj F2837xD_PieCtrl.obj F2837xD_PieVect.obj F2837xD_SysCtrl.obj F2837xD_usDelay.obj F2837xD_CodeStartBranch.obj F2837xD_Dma.obj F2837xD_Adc.obj F2837xD_Gpio.obj F2837xD_Ipc_Driver_Lite.obj c2000HardwareTimerConfig.obj MW_c28xGPIO.obj clb.obj c2837xDSchedulerTimer0.obj
...
%.obj : $(START_DIR)/PR02_ert_rtw/%.cla
	$(CC) $(CFLAGS) --output_file="$@" "$<"


%.obj : $(START_DIR)/PR02_ert_rtw/%.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


%.obj : $(START_DIR)/PR02_ert_rtw/%.asm
	$(AS) $(ASFLAGS) --output_file="$@" "$<"


%.obj : $(START_DIR)/PR02_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) --output_file="$@" "$<"
...
MW_c28xx_csl.obj : $(START_DIR)/PR02_ert_rtw/MW_c28xx_csl.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


MW_c28xx_board.obj : $(START_DIR)/PR02_ert_rtw/MW_c28xx_board.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


MW_c28xx_pwm.obj : $(START_DIR)/PR02_ert_rtw/MW_c28xx_pwm.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


PR02.obj : $(START_DIR)/PR02_ert_rtw/PR02.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


PR02_data.obj : $(START_DIR)/PR02_ert_rtw/PR02_data.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


ert_main.obj : $(START_DIR)/PR02_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"
